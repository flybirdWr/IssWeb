        ...
        <div class="col-xs-12 col-md-9">
                    ...
                    <div class="question-message" style="float:left;width: 100%;">
                        <div class="summary" style="margin-top: 20px;">
                            ...
                            <ul class="author list-inline pull-right">
                                <li class="">
                                    <img src="../Icons/zancheng.png" width="15"> <a href="/main/ThumbServlet?<%=KeyConst.ARTICLE_ID%>=<%=aid%>">赞(<%=thumb%>)</a>
                                </li>
                                <li class="">
                                    <img src="../Icons/fandui.png" width="15"> <a href="/main/StepServlet?<%=KeyConst.ARTICLE_ID%>=<%=aid%>">踩(<%=step%>)</a>
                                </li>
                              <%--  <li class="">
            ...
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs" style="margin-top:25px;">
                    <li>
                        <a style="font-size: 1.2em;padding:0;">
                            我的回答
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="answers" style="margin-top:25px;">
                    ...
                    <%
                        ...
                        List<article> at1=pageDao.queryByPage("where parent_article=" + aid, article.class, p);
                        for(article a1:at1){
                            User u2=a1.getU();
                    ...
                    <div class="question_list answerBox" style="padding:20px 10px 30px 10px;">
                        ...
                        <div class="time">
                            <ul class="author list-inline" style="margin-bottom:0px;">
                                ...
                                <li class="">
                                    <img src="/Icons/shanchu.png" width="15"><a href="<%=PathConst.ServletPath.delete_servlet%>?<%=KeyConst.ARTICLE_ID%>=<%=childid%>"> 删除</a>
                                </li>
                               <%-- <li class="">
                                    <img src="/Icons/jubao.png" width="15"><a> 举报</a>
                                </li>--%>
